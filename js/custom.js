        ...
        (function () {
            if ($('[data-section="map"]').length) {
                ...
                window.initGmap = function () {
                    ...
                    var $latlng = new google.maps.LatLng(49.960496,4.2328923),
                        $mapOptions = {
                            zoom: 10,
                            center: $latlng,
                            panControl: false,
                ...
                loadScript('http://maps.googleapis.com/maps/api/js?v=3&sensor=false&key=AIzaSyC2xu3JFLngXN-zJFPn5rCFiCi5UrjBFFc&callback=initGmap', 'gmapSrc');
            }
        })();
